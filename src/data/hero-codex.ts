...
const WRITING: Record<string, CodexWriting> = {
    ...
    shangguan: {
        ...
        tips: ['落笔可放在四方向1~3格的任意格，包括敌人所在格（立即造成6点固定伤害）；毛笔每回合朝你移动1格、最多移动3次后消散。', '连冲自选方向逐段冲刺：命中敌人或毛笔即造成6点固定伤害并停下，可再选新方向继续；同一目标不可重复命中，毛笔在连冲期间静止，行动结束后才移动。', '冲刺落点为目标身后一格，被阻挡时停在目标前一格贴脸攻击；所有伤害都会为你累积墨意，越冲越能攒出闪避。'],
    },
    skeletonking: {
        epithet: '骸骨君王',
        role: '死亡体系 · 护盾复活',
    ...
    zuizhendao: {
        epithet: '醉卧沙场',
        role: '掷刀穿行 · 醉意攻防',
        summary: '掷刀穿越敌阵积累醉意，与友方换位打出范围斩击；醉意越高，闪避与反击越强。',
        difficulty: 3,
        tags: ['醉意', '位移', '闪避反击'],
        ...
        tips: ['技能1掷刀尽量穿越更多敌人叠醉意，醉意高了再换位斩。', '与李太白配合：踩过他的格子可转移醉意，还能多走一步。'],
    },
    feynman: {
        epithet: '粒子加速者',
        role: '标记构型 · 范围爆发',
