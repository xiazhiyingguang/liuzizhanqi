...
const WRITING: Record<string, CodexWriting> = {
    ...
    youjun: {
        ...
        epithet: '裂风猎隼',
        role: '直线穿透 · 距离蓄力爆发',
        summary: '借风道滑行与自身乘风叠层，沿直线穿透敌阵，伤害随冲刺距离与上一回合位移攀升，是风系三人组的爆发终结点。',
        difficulty: 3,
        tags: ['直线冲刺', '距离蓄力', '穿透', '风道联动', '再动'],
        resource: '上回合移动距离与乘风层数',
        passive: { name: '再动', description: '每次使用技能结束后，可再次移动一次（仅移动，不可再放技能）。' },
        tianwei: { name: '天威 · 裂空', description: '击杀敌人后，对死亡格所在整行与整列的其余敌人造成5点伤害，并各施加1层羽化与1层逆风。' },
        tips: [
            '疾掠伤害 = 5×(1+冲刺距离×0.1)×(1+上回合移动距离×0.1)，并吃乘风每层+15%：起点站在与冲刺同向的友方风道上时冲刺上限从3提升到6，南风天威铺出的行列风道就是最佳跑道。',
            '上一回合位移越大，本回合疾掠越疼——先用移动或乘风滑过南风风道攒满位移，再下回合冲刺爆发。',
            '乘风（技能2）免费滑行并叠加增伤，适合没有风道时自行蓄力，或为下回合疾掠铺好乘风层数。',
        ],
    },
    chenyuan: {
        skillNames: ['渊引', '寒渊庇护'],
